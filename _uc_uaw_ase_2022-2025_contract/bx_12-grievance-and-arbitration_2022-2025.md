...
<div class="lvl4"><h4 class="inline-header">f)</h4> Receipt of the <span class="tooltip">grievance<span class="tooltip-text"><b>Grievance</b>: {% assign tooltip_term = site.data.union_glossary | where: "Term", "grievance" %}{{ tooltip_term[0]["Meaning"] }}</span></span> shall be acknowledged in writing by the University as soon as practicable following receipt, and shall be sent to the address or email listed on the grievance form.
...
</div><!-- End of level 2: B. FILING GRIEVANCES-->
</div><!-- End of level 3: 3. Proper Filings - Initial Grievances, Responses and Appeals-->
...
</div><!-- End of level 3: 1. Step 1 (Optional) Informal Resolution-->
</div><!-- End of level 4: b)-->
...
</div><!-- End of level 3: 2. Step 2 - Formal Campus Level-->
</div><!-- End of level 4: c)-->
...
</div><!-- End of level 2: J. APPEAL TO ARBITRATION-->
</div><!-- End of level 3: 2. Procedure-->
...
<div class="lvl3"><h3 class="inline-header">4.</h3> At the time the University and the UAW schedule the Pre-<span class="tooltip">Arbitration<span class="tooltip-text"><b>Arbitration</b>: {% assign tooltip_term = site.data.union_glossary | where: "Term", "arbitration" %}{{ tooltip_term[0]["Meaning"] }}</span></span> Conference, each party shall identify the names of the participants.
...
</div><!-- End of level 2: K. SELECTION OF THE ARBITRATOR/PRE-ARBITRATION CONFERENCE-->
...
</div><!-- End of level 3: 4. Written Briefs-->
</div><!-- End of level 4: c.-->
...
</div><!-- End of level 3: 7. Hearing on Arbitrability-->
...
</div><!-- End of level 2: L. BIFURCATION-->
</div><!-- End of level 3: 8. -->
...
</div><!-- End of level 2: M. MEDIATION (optional step)-->
...
</div><!-- End of level 2: N. PROCEDURAL/EVIDENTIARY ISSUES AT HEARING-->
</div><!-- End of level 3: 6.-->
...
</div><!-- End of level 2: O. SCOPE OF ARBITRATOR'S AUTHORITY-->
</div><!-- End of level 3: 4.-->
...
</div><!-- End of level 2: P. RELEASE TIME FOR ARBITRATION FOR THE ASE GRIEVANT AND ASE REPRESENTATIVE-->
</div><!-- End of level 3: 2.-->
...
</div><!-- End of level 2: Q. APRBITRATOR PANEL-->
</div><!-- End of level 3: 2.-->
</div><!-- End of level 4: c.-->
